...
public class UserBasedGivingsPieChartService extends ChartService2D<Giving>{
	...
	private final String WEB_SOCKET_APP_CHANNEL = "/2-dimensional/user";
	private final String WEB_SOCKET_PUBLISH_CHANNEL = "/topic/2-dimensional/user";
	...
	@PostConstruct
	public void init() {
		GivingDataSource givingDataSource = new GivingDataSource(new Long[]{new Long(1500206400000l),Long.MAX_VALUE}, giftRepository, receivingEventFactory);
