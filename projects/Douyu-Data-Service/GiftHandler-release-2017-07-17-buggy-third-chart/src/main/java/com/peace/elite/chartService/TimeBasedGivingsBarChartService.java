...
public class TimeBasedGivingsBarChartService extends ChartService2D<Giving>{
	...
	private final String WEB_SOCKET_APP_CHANNEL = "/2-dimensional/time";
	private final String WEB_SOCKET_PUBLISH_CHANNEL = "/topic/2-dimensional/time";
	...
	@PostConstruct
	public void init() {
		Long[] range = {new Long(1500206400000l),Long.MAX_VALUE};
		Long length = 300000l;
