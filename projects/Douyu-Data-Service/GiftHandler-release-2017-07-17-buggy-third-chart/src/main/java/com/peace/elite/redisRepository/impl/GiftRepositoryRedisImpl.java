...
public class GiftRepositoryRedisImpl extends GiftRepository {
	...
	private HashOperations<String, String, Long> hashLongOperation;
	@PostConstruct
	private void init() {
	...
	public void receive(long uid, long gid, long timeStamp, String valueUserName) {
		...
		hashOperations.put(keyGiving, "uid", ""+uid);
		hashOperations.put(keyGiving, "gid", ""+gid);
		hashOperations.increment(keyGiving, "counter", 1l);
...
//		}
	...
	public String getCountGiving(String keyGiving) {
		return hashOperations.get(keyGiving, "counter");
	...
	@Override
	public Set<TypedTuple<String>> givingsTimeOriented(long max, long min) {
		// TODO Auto-generated method stub
		return zetOperations.reverseRangeByScoreWithScores(GIVINGS_TIME_LINE, (double)max, (double)min);
	}
	...
	public void handle(Event<Giving> e) {
		...
		long gid = e.getData().getGid();
		long timeStamp = e.getData().getTimeStamp();
		String valueUserName = e.getData().getUserName();
		this.receive(uid, gid, timeStamp, valueUserName);
	}

	@Override
	public long getGivingUid(String keyGiving) {
		return Long.parseLong(hashOperations.get(keyGiving, "uid"));
	}

	@Override
	public long getGivingGid(String keyGiving) {
		// TODO Auto-generated method stub
		return Long.parseLong(hashOperations.get(keyGiving, "gid"));
	}
}
