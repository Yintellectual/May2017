...
public class DynamicPartition2D<T> extends Partitions2D<T>{
	...
	public DynamicPartition2D(BiPredicate<Giving, T> predicate, Function<Iterable<Giving>, Long> reduce, Function<T, String> labelGeneration, Function<T, String> idGenerator, Function<Giving, T> partitionGenerator, GivingDataSource dataSource){
