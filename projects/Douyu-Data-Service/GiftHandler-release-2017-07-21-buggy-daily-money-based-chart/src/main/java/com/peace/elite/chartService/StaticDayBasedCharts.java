...
@Controller
public class StaticDayBasedCharts {//implements Listener<BoundaryWrapper<Long>>{
...
//	private Clocker clocker;
	...
	private final String WEB_SOCKET_APP_CHANNEL = "/2-dimensional/static_day_chart";
	private final String WEB_SOCKET_PUBLISH_CHANNEL = "/topic/2-dimensional/static_day_chart";
